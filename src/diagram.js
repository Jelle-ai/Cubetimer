...
function derive(stickers) {
  ...
  // Every face as its own three by three, in the net's own orientation. The
  // last-layer pictures only need the top and the band around it; the three-
  // dimensional cube needs all six, and it reads them from here.
  const faces = {};
